        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavLink to='/category/Procesadores' className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>Procesadores</NavLink>
              ...
              <NavLink to='/category/Placa de Video' className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>Placas de Video</NavLink>
               
              </NavDropdown.Item>
              <NavDropdown.Item href="#action/3.3">
              <NavLink to='/category/Memoria Ram' className={({ isActive }) => isActive ? 'ActiveOption' : 'Option'}>Memoria Ram</NavLink>
